...
public class MainController {
    ...
    @ResponseBody
    public PersistentEntityResource getFoodStorage(@PageableDefault(size = 20, sort = "id") Pageable pageable,
    ...
    @ResponseBody
    public PersistentEntityResource getPatients(@PageableDefault(size = 20, sort = "id") Pageable pageable,
                                                PersistentEntityResourceAssembler asm) {
    ...
    @ResponseBody
    public PersistentEntityResource getStock(@PageableDefault(size = 20, sort = "id") Pageable pageable,
                                             PersistentEntityResourceAssembler asm) {
